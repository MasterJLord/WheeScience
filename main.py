...
for i in range(2):
    if random.randint(0, 1) == 0:
        ...
        RandomlyChosenPresets.append(PresetsOptions[random.randint(0, len(PresetsOptions)-1)])

class Blank:
    def __init__(self, information: dict):
        self.PresetName = information["PresetName"]
                ...
                if PlayerCoordinates[1] > Platforms[1][1] and PlayerCoordinates[1]+Momentum[1]*FrameTime/1000 <= Platforms[1][1]:
                    ...
                    if tempa >= Platforms[1][0] and tempa <= Platforms[1][0]+Platforms[1][2]:
                        ...
                        if tempa < Settings.JumpVelocity/Settings.Gravity:
                            ...
                            temp2 = random.randint(math.floor(Platforms[1][1]+(Settings.JumpVelocity**2/Settings.Gravity)/4-Settings.MaximumForgiveness), math.floor(Platforms[1][1]+(Settings.JumpVelocity**2/Settings.Gravity)/2-Settings.MinimumForgiveness))
                        else:
